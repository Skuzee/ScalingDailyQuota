...
namespace ScalingDailyQuota
{
    ...
    {
        public static ConfigEntry<bool>? playerScaling;
        ...
        public static ConfigEntry<string>? playerRevive_source;
        public static ConfigEntry<int>? playerRevive_creditCost;
        public static ConfigEntry<int>? playerRevive_quotaPenaltyAmount;
        public static ConfigEntry<int>? playerRevive_respawnTimer;
        ...
        {
            playerScaling = base.Config.Bind(
            "Angst",
            "Player Scaling?",
            true,
            "Scale certain config settings depending on player count"    // Description
            );
            ...
            100,
            "If player scaling is enabled, the quota on the first day will start at this amount, Per-Player"    // Description
            );
            ...
            100,
            "If player scaling is enabled, the quota will increase daily by this amount, Per-Player."    // Description
            );
            ...
            3,
            "Sets how many days are in a quota cycle. aka how often the Difficulty Increase happens."    // Description
            );
            ...
            25,
            "If player scaling is enabled, the Per-Player Daily Quota will increase this much per-completed quota cycle."    // Description
            );
            ...
            500,
            "If player scaling is disabled, the quota will start at this fixed amount."    // Description
            );
            ...
            500,
            "If player scaling is disabled, the quota will increase daily by this fixed amount."    // Description
            );
            ...
            500,
            "If player scaling is disabled, the Daily Quota will increase this much per-completed quota cycle."    // Description
            );
            ...
            "PlayerAndCompany",
            "Determines if a dead player can be revived by Player, Company, PlayerAndCompany, or NONE"    // Description
            );
            ...
            100,
            "Credit cost to revive a dead player."    // Description
            );
            ...
            100,
            "If player dies, and is revived by The Company, the quota will increase this amount."    // Description
            );
            ...
            300,
            "How long before The Company respawns a dead player?"    // Description
            );
        ...
        public static void SetNewQuotaAtEndOfCycle(int otb)
        {
            ...
            // Reset quota tracker, this should roll over quota
